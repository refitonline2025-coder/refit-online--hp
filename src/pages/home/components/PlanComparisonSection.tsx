    ...
    if (value) {
      return (
        <div className="flex items-center justify-center">
          <div className="w-8 h-8 rounded-full bg-[#E8725A] flex items-center justify-center">
      ...
      <div className="px-5">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            あなたに合った<span className="text-[#E8725A]">プラン</span>を選ぼう
          </h2>
                      ...
                      {feature.included ? (
                        <i
                          className={`ri-check-line text-lg flex-shrink-0 mt-0.5 ${
                            plan.premium ? 'text-orange-500' : 'text-[#E8725A]'
                          }`}
                        ></i>
                      ) : (
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-10 border border-gray-200 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-4 border-b border-gray-200">
            ...
            <div className="px-4 py-5 text-center border-l border-gray-200 bg-[#FDF4F2]/60">
              <span className="text-sm font-bold text-[#E8725A]">スタンダードプラン</span>
            </div>
          ...
          {comparisonItems.map((item, index) => (
            ...
            >
              ...
              <div className="px-6 py-6 flex items-center gap-3">
                {item.icon && (
                  <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                    <i className={`${item.icon} text-[#E8725A] text-base`}></i>
                  </div>
                )}
              ...
              {/* スタンダード */}
              <div className="px-4 py-6 flex items-center justify-center border-l border-gray-100 bg-[#FDF4F2]/30">
