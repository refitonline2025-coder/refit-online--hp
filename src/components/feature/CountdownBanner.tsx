      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-lg px-5 py-2.5">
            <div className="w-8 h-8 flex items-center justify-center">
              <i className="ri-user-add-line text-xl text-rose-500"></i>
            </div>
            <div>
              ...
              <div className="text-xl font-bold text-gray-900 leading-none whitespace-nowrap">
                残り<span className="text-rose-500 mx-1">6名</span>様
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-gray-600">
              <div className="w-5 h-5 flex items-center justify-center">
                <i className="ri-time-line text-base text-rose-500"></i>
              </div>
        ...
        <div className="md:hidden text-center mt-2">
          <p className="text-gray-500 text-xs whitespace-nowrap">
            <i className="ri-time-line mr-1 text-rose-500"></i>
            キャンペーン終了まで
          </p>
        </div>
      </div>
